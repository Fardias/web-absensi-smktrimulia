          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{stats.hadirHariIni}</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              {user.role === 'admin' && (
                <>
                  ...
                  <button className="w-full text-left p-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition duration-200">
                    <div className="flex items-center">
                      <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
